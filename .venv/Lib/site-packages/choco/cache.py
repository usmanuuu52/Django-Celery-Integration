...
from choco import compat, util

_cache_plugins = util.PluginLoader("choco.cache")

register_plugin = _cache_plugins.register
register_plugin("beaker", "choco.ext.beaker_cache", "BeakerCacheImpl")
...
class Cache(object):
    ...
    .. versionadded:: 0.6
       ...
       implement different
       caching strategies.   Choco includes a backend that works with
