...
from choco.ext.extract import MessageExtractor


class BabelChocoExtractor(MessageExtractor):
    ...
    def __init__(self, keywords, comment_tags, options):
        ...
        super(BabelChocoExtractor, self).__init__()
...
def extract(fileobj, keywords, comment_tags, options):
    """Extract messages from Choco templates.
    ...
    :rtype: ``iterator``
    """
    extractor = BabelChocoExtractor(keywords, comment_tags, options)
